...
TARGET_USE_QTI_BT_AIDL := true
endif

ifeq ($(TARGET_USE_QTI_BT_AIDL), true)
TARGET_EXCLUDE_QTI_BT_HIDL := true
else
...
TARGET_USE_QTI_BT_HAL_RPC := false
ifeq ($(TARGET_USE_QTI_BT_HAL_RPC), true)
TARGET_ENABLE_QTI_BT_HCI_PROTO := true
TARGET_USE_QTI_BT_HAL_RPC_SERVER := false
endif
endif
endif
endif
