#ANT
ifneq ($(TARGET_BOARD_DERIVATIVE_SUFFIX),$(filter $(TARGET_BOARD_DERIVATIVE_SUFFIX), _cdccomm _cdcsdv _sdvcomm _sdv))
...
PRODUCT_PACKAGES += aidl_fuzzer_bluetooth_hal
...
#
PRODUCT_PROPERTY_OVERRIDES += persist.vendor.bluetooth.hal.mode=default
